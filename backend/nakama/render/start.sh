...
RUNTIME_ENV_TPX_TELEMETRY_EVENTS_URL="${TPX_PLATFORM_TELEMETRY_EVENTS_URL:-${TPX_PLATFORM_TELEMETRY_URL:-}}"
...
runtime:
  ...
  env:
    ...
    - "TPX_PLATFORM_TELEMETRY_EVENTS_URL=${RUNTIME_ENV_TPX_TELEMETRY_EVENTS_URL}"
